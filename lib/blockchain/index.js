...
class Blockchain {
    ...
    getTransactionFromBlocksByHash(transactionId) {
        return R.find(R.compose(R.find(R.propEq('hash', transactionId)), R.prop('transactions')), this.blocks);
    }
    ...
    getStakeTransactionFromBlocksByAdress(address) {
        //return R.find(R.compose(R.find(R.propEq('id', transactionId)), R.prop('transactions')), this.blocks);
        //return R.find(R.compose(R.find(R.propEq('id', transactionId)), R.prop('transactions')), this.blocks);
        let blocks = R.clone(this.blocks);
